...
public class LikeAdapter extends RecyclerView.Adapter<LikeAdapter.CustomViewHodler> {
    ...
    public LikeAdapter(Context context, ArrayList<LikeDTO> likeDTOArrayList) {
        this.mContext = context;
        sessionManager = new SessionManager(context);
        activity = (Activity) context;
        requestQueue = Volley.newRequestQueue(context);
        this.likeDTOArrayList = likeDTOArrayList;
    }
    ...
    public void onBindViewHolder(CustomViewHodler holder, final int position) {
        final LikeDTO likeDTO = likeDTOArrayList.get(position);
        ...
        holder.dislikeLL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String pos=likeDTOArrayList.get(position).getId();
                likeDTOArrayList.remove(position);
