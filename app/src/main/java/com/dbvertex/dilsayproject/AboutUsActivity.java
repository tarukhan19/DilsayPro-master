...
public class AboutUsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(AboutUsActivity.this, R.style.CustomDialog);
        queue = Volley.newRequestQueue(AboutUsActivity.this);
    ...
    private void loadData()
    {
        ...
        StringRequest postRequest = new StringRequest(Request.Method.GET, EndPoints.ABOUTUS,
