...
public class TermsandConditionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(TermsandConditionActivity.this, R.style.CustomDialog);
        queue = Volley.newRequestQueue(TermsandConditionActivity.this);
        ...
        back_LL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TermsandConditionActivity.this, HomePageActivity.class);
    ...
    private void loadData()
    {
        ...
        StringRequest postRequest = new StringRequest(Request.Method.GET, EndPoints.TERMS_CONDITION,
